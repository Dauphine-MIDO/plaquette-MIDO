...
public class DocBookHelper {
   ...
   * @throws XmlException If an error occurs when parsing the stylesheet or when transforming the
   *         document.
   */
  ...
  public void foToPdf(Source fo, OutputStream pdfStream) throws IOException, XmlException {
    ...
    foUserAgent.getEventBroadcaster().addEventListener(e -> e.setSeverity(EventSeverity.FATAL));
